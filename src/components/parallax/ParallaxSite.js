...
function ParallaxSite() {
    ...
    return (
        <React.Fragment>
            ...
            <section>
                <h1 className='display-1'>ParallaxSite Page 1</h1>
                ...
                {/* <img
                    ...
                    width="100%"
                    src=""
                    style={{ width: '100%', height: 'auto', marginTop: `${positionY}px`, position: 'absolute' }} /> */}
            </section>

            <section>
                <h1 className='display-1'>ParallaxSite Page 2</h1>
